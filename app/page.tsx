    ...
    <main>
      <nav className="nav-shell" aria-label="Main navigation">
        ...
        <div className="nav-links">
          ...
          <a className="nav-cta" href="/download">Download v0.6</a>
        </div>
      </nav>
      ...
      <section className="hero" id="top">
        <div className="hero-copy">
          ...
          <div className="hero-actions">
            <a className="button primary" href="/download">Download v0.6 <span>↓</span></a>
      ...
      <section className="section install" id="install">
        ...
        <a className="button primary download-wide" href="/download">Download Page Capture v0.6 <span>↓</span></a>
      </section>
      ...
      <section className="closing">
        ...
        <a className="button inverse" href="/download">Start with v0.6 <span>→</span></a>
      </section>

      <footer className="site-footer">
        <div className="brand"><span className="brand-mark" aria-hidden="true"><i /></span><span><strong>Page Capture</strong><small>Developer preview · v0.6.0</small></span></div>
