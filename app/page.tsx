  ...
  return (
    <main>
      ...
      <section className="hero" id="top">
        <div className="hero-copy">
          ...
          <div className="hero-actions">
            <a className="button primary" href="/license-page-capture-v0.5.0.zip" download>Download v0.5 <span>↓</span></a>
      ...
      <section className="section install" id="install">
        ...
        <a className="button primary download-wide" href="/license-page-capture-v0.5.0.zip" download>Download Page Capture v0.5 <span>↓</span></a>
      </section>
      ...
      <section className="closing">
        ...
        <a className="button inverse" href="/license-page-capture-v0.5.0.zip" download>Start with v0.5 <span>→</span></a>
      </section>

      <footer className="site-footer">
        <div className="brand"><span className="brand-mark" aria-hidden="true"><i /></span><span><strong>Page Capture</strong><small>Developer preview · v0.5.0</small></span></div>
